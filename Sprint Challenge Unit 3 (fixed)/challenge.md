...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  Something that I look for when reviewing code is understanding what it is doing and can I read it well without having to look at comments even though comments is apart of good
  well written code.
  And something I appreciate when my code is getting a reviwed is everything, tell me something I need to work on and give me tips and what to do better.
  Its a learning a process.
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation? Containers would help in varying degrees but also not do so much for some. Some people who are familiar with containers would beneifit
  but the people who were not exposed to containers would add layer of confusion especially since this the first time most people would be exposed to this tool.
